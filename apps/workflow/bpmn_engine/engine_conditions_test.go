...
// func Test_exclusive_gateway_with_expressions_and_events_selects_one_and_not_the_other(t *testing.T) {
// 	// setup
// 	bpmnEngine := New("name")
// 	cp := CallPath{}
//
// 	// given
// 	process, _ := bpmnEngine.LoadFromFile("../../test-cases/exclusive-gateway-with-condition-events.bpmn")
// 	bpmnEngine.AddTaskHandler("task-a", cp.CallPathHandler)
// 	bpmnEngine.AddTaskHandler("task-b", cp.CallPathHandler)
// 	variables := map[string]interface{}{
// 		"price": -50,
...
//
// 	// when
// 	pi, _ := bpmnEngine.CreateAndRunInstance(process.ProcessKey, variables)
// 	bpmnEngine.PublishEventForInstance(pi.GetInstanceKey(), "b")
