...
import (
	...
	repository2 "go-web-mini/apps/system/repository"
...
type RoleController struct {
	...
	mr             repository2.IMenuRepository
	uc             repository2.IUserRepository
	ur             repository2.IUserRepository
	ar             repository2.IApiRepository
}
...
func (rc RoleController) CreateRole(c *gin.Context) {
	...
	sort, ctxUser, err := rc.uc.GetCurrentUserMinRoleSort(nil, c)
	if err != nil {
...
func (rc RoleController) UpdateRoleById(c *gin.Context) {
	...
	minSort, ctxUser, err := rc.ur.GetCurrentUserMinRoleSort(nil, c)
	if err != nil {
		response.Fail(c, nil, err.Error())
		return
	}
...
func (rc RoleController) UpdateRoleMenusById(c *gin.Context) {
	...
	ctxUserMenus, err := rc.mr.GetUserMenusByUserId(nil, ctxUser.ID)
	if err != nil {
...
func (rc RoleController) UpdateRoleApisById(c *gin.Context) {
	...
	apis, err := rc.ar.GetApisById(nil, apiIds)
	if err != nil {
...
func (rc RoleController) BatchDeleteRoleByIds(c *gin.Context) {
	...
	// 获取当前用户最高等级角色
	//ur := repository.NewUserRepository()
	minSort, _, err := rc.ur.GetCurrentUserMinRoleSort(nil, c)
	if err != nil {
		response.Fail(c, nil, err.Error())
		return
	}
