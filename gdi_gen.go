...
//go:embed generator middleware routes common dto docs response config controller model repository vo service util
...
func init() {
	...
	gdi.PlaceHolder((*p8.BranchTab)(nil))
	gdi.PlaceHolder((*p8.BranchTabQuery)(nil))
	...
	gdi.PlaceHolder((*p9.BranchTabRepository)(nil))
	gdi.PlaceHolder((*p9.MenuRepository)(nil))
	gdi.PlaceHolder((*p9.News2Repository)(nil))
	...
	gdi.PlaceHolder((*p12.BranchTabService)(nil))
	gdi.PlaceHolder((*p12.News2Service)(nil))
	...
	gdi.PlaceHolder((*p14.PagerBranch)(nil))
	...
	gdi.PlaceHolder((*p14.BranchTab)(nil))
	gdi.PlaceHolder((*p14.PagerBranchTab)(nil))
	gdi.PlaceHolder((*p14.ListBranchTabRequest)(nil))
	gdi.PlaceHolder((*p14.CreateBranchTabRequest)(nil))
	gdi.PlaceHolder((*p14.UpdateBranchTabRequest)(nil))
	gdi.PlaceHolder((*p14.DeleteBranchTabRequest)(nil))
	gdi.PlaceHolder((*p14.GetBranchTabRequest)(nil))
	...
	gdi.PlaceHolder((*p14.PagerNews)(nil))
